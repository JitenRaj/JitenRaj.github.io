...
export const projects = [
    ...
    },
    {
        ...
        tags: ["Java", "MDX", "Docker", "GitHub"],
        tagColor: "green",
        desc: "A comprehensive collection of Java and Design Patterns <strong>programming notes</strong>, <strong>code snippets</strong>, and concepts ranging from core syntax to advanced topics. Ideal for revision, learning, and interview preparation.",
        linkText: "Launch App",
        linkColor: "text-blue-400 hover:text-green-300",
        url: "https://SpringBolt.mintlify.app/"
    },
    {
        title: "Gemini AI Generator",
        icon: "sparkles",
        iconColor: "text-purple-400",
        tags: ["Java", "Gemini API", "Gradle"],
        tagColor: "purple",
    ...
    },
    {
        ...
        tagColor: "cyan",
        desc: "A distributed banking ledger system built with <strong>Microservices architecture</strong>. Utilized <strong>Apache Kafka</strong> for event-streaming and Redis caching to handle 10k+ transactions per second.",
        linkText: "View Code",
    ...
    },
    {
        ...
        linkText: "View Details",
        linkColor: "text-blue-400 hover:text-orange-300",
        url: "#"
    }
];